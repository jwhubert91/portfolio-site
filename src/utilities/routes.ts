...
const reservedPathSegments = ["accounts", "account", "settings", "setting", "portful", "portfuls", "portfolio", "profile", "help", "contact", "about", "info", "explore", "feed", "jobs", "job", "saved", "notifications", "messages", "create", "edit", "new", "handle", "logout", "chat"]